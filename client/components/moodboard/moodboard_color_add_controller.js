...
class MoodBoardColorAddController extends Component{
    ...
    add_color_in_arts(){
        ...
        canvas.fillStyle=this.refs.color_picker.value
        console.log(this.refs.color_picker.value)
        ...
        image.onload = function(){
            ...
            arts[id]={
                file: src,
                color: _this.refs.color_picker.value,
                position: undefined, 
    ...
    render(){
        return(<div className='controller moodboard_color_add_controller'>
            <div style={{display:'inline-block'}}>
                <input ref='color_picker' type='color' style={{width: '36px', height: '36px'}}>
